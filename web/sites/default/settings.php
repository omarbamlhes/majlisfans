 ...
 * @endcode
 */
$settings['hash_salt'] = 'i_C3e21CvPcohmCmAQHbpqmRggBWPlJjZhUJpglVGlYGI_LsRUgD9hmVF6I6gup1XP320IHD1A';
...
# Enable the Critical CSS module to inline critical CSS on page load.
$config['critical_css.settings']['generate_on_import'] = TRUE;
$config['critical_css.settings']['always_inline'] = TRUE;

// Performance optimizations added by automation (Redis cache + asset preprocessing)
if (file_exists('/usr/bin/redis-server')) {
  $settings['redis.connection']['interface'] = 'PhpRedis';
  $settings['redis.connection']['host'] = 'redis';
  $settings['cache']['default'] = 'cache.backend.redis';
  // Use fast chained backend for bootstrap & config.
  $settings['cache']['bins']['bootstrap'] = 'cache.backend.chainedfast';
  $settings['cache']['bins']['discovery'] = 'cache.backend.chainedfast';
  $settings['cache']['bins']['config'] = 'cache.backend.chainedfast';
}

// Enable gzip compression and asset preprocessing.

// HTTP cache control: set max-age for anonymous users.
$config['http_cache_control.settings']['max_age'] = 3600;
// HTTP Cache Control settings with longer TTL
$config['http_cache_control.settings']['cache_maximum_age'] = 86400; // 24 hours for static assets
...
$config['responsive_image.settings']['fallback_image_style'] = 'webp';
